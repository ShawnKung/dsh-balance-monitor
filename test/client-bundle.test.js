...
test('client bundle uses credential status dots and inline channel actions', async () => {
  ...
  assert.match(clientSource, /bm-channel-website/)
  assert.match(clientSource, /target: '_blank'/)
  assert.match(clientSource, /rel: 'noopener noreferrer'/)
  assert.match(clientSource, /https:\/\/platform\.deepseek\.com\/usage/)
  assert.match(clientSource, /https:\/\/platform\.kimi\.com\/console\/account/)
  assert.match(clientSource, /https:\/\/bigmodel\.cn\/finance-center\/finance\/overview/)
  assert.match(clientSource, /https:\/\/teamorouter\.com\/dashboard/)
  assert.doesNotMatch(clientSource, /bm-label-wrap/)
